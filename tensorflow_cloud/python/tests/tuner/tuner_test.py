...
from tensorflow_cloud.python.tuner import tuner
from tensorflow_cloud.python.tuner.tuner import optimizer_client
...
class TunerTest(tf.test.TestCase):
  ...
  def test_tuner_initialization_with_hparams(self):
    ...
    self.mock_optimizer_client_module.create_or_load_study.assert_called_with(
        self._project_id, self._region,
        'Tuner_study_{}'.format(self._study_id), self._study_config)
