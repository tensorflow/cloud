...
from tensorflow_cloud.python.tuner import tuner_utils
from tensorflow_cloud.python.tuner import optimizer_client
...
class CloudOracle(oracle_module.Oracle):
  ...
  def __init__(self,
    ...
    if study_config:
      ...
      objective = tuner_utils.convert_study_config_to_objective(
          study_config)
      hyperparameters = tuner_utils.convert_study_config_to_hps(
          study_config)
  ...
  def get_best_trials(self, num_trials = 1):
    ...
    maximizing = tuner_utils.format_goal(
