...
class TestValidate(unittest.TestCase):
    def test_valid_args(self):
        validate.validate(
            entry_point="tensorflow_cloud/python/tensorflow_cloud/tests/testdata/mnist_example_using_fit.py",
            distribution_strategy="auto",
            requirements_txt="tensorflow_cloud/python/tensorflow_cloud/tests/testdata/requirements.txt",
        ...
        validate.validate(
            entry_point="tensorflow_cloud/python/tensorflow_cloud/tests/testdata/mnist_example_using_fit.ipynb",
            distribution_strategy=None,
            requirements_txt="tensorflow_cloud/python/tensorflow_cloud/tests/testdata/requirements.txt",
            chief_config=machine_config.COMMON_MACHINE_CONFIGS["K80_1X"],
            worker_config=None,
