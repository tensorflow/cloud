...
cd cloud
pip install tensorflow_cloud/python/.
```
...
As described in the [high level overview](#high-level-overview), the `run` API allows you to train your models at scale on GCP. The [`run`](https://github.com/tensorflow/cloud/blob/master/tensorflow_cloud/python/core/run.py#L31) API can be used in four different ways. This is defined by where you are running the API (Terminal vs IPython notebook), and your `entry_point` parameter. `entry_point` is an optional Python script or notebook file path to the file that contains your TensorFlow Keras training code. This is the most important parameter in the API.
...
```shell
cd tensorflow_cloud/python/tensorflow_cloud
python tests/integration/call_run_on_script_with_keras_fit.py
```

- [Using a python file as `entry_point` (Keras fit API)](https://github.com/tensorflow/cloud/blob/master/tensorflow_cloud/python/tensorflow_cloud/tests/integration/call_run_on_script_with_keras_fit.py).
- [Using a python file as `entry_point` (Keras custom training loop)](https://github.com/tensorflow/cloud/blob/master/tensorflow_cloud/python/tensorflow_cloud/tests/integration/call_run_on_script_with_keras_ctl.py).
- [Using a python file as `entry_point` (Keras save and load)](https://github.com/tensorflow/cloud/blob/master/tensorflow_cloud/python/tensorflow_cloud/tests/integration/call_run_on_script_with_keras_save_and_load.py).
- [Using a notebook file as `entry_point`](https://github.com/tensorflow/cloud/blob/master/tensorflow_cloud/python/tensorflow_cloud/tests/integration/call_run_on_notebook_with_keras_fit.py).
- [Using `run` within a python script that contains the `tf.keras` model](https://github.com/tensorflow/cloud/blob/master/tensorflow_cloud/python/tensorflow_cloud/tests/integration/call_run_within_script_with_keras_fit.py).
- [Using cloud build instead of local docker](https://github.com/tensorflow/cloud/blob/master/tensorflow_cloud/python/tensorflow_cloud/tests/integration/call_run_on_script_with_keras_fit_cloud_build.py).
- [Run AutoKeras with TensorFlow Cloud](https://github.com/tensorflow/cloud/blob/master/tensorflow_cloud/python/tensorflow_cloud/tests/integration/call_run_within_script_with_autokeras.py).
